...
valgrind --leak-check=full --leak-resolution=high --show-leak-kinds=all --num-callers=20 --trace-children=yes --log-file=valgrind.log  --suppressions=${SUPP_DIR}/gst.supp --suppressions=${SUPP_DIR}/glib.supp ./${APP_NAME}
}
